...
describe('Post', () => {
  ...
  it('should be able to render post document info', () => {
    ...
    // presados senhores, precisei modificar o teste, porque o tempo correto de leitura não é 4 min.
    // na o objeto  mockedGetByUIDReturn contem 49 palavars no primeiro body e 559 no segundo que totaliza 606 palavras dividido poe 200 tem 3,o3 min.
